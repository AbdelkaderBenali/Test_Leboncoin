...
describe("T 3 : Consultation et paiement", ()=>{
    ...
    it("T 3.1 : Consultation d'une annonce", ()=>{
        ...
        const data = {
            ...
            amount:1000,
            description:"test",
            offers:[`${id}`] // id à verifier son existance avant chaque test /!\
        };
    ...
    it("T 3.2 Paiement", () =>{
        ...
        .then( response => {
            console.log("reponse T 3.2 paiement")
            console.log("STATUS : "+response.status)
            console.log("Confirmation : "+response.data.paid);
...
describe("T 4 : Suppression d'une annonce", ()=>{
    ...
    it("T 4.1 Suppression annonce de l'utilisateur1 par l'utilisateur2", () => {
        return axios({
            ...
            .catch(error => {
            console.log("error T 4.1 supp par autre user")
    ...
    it("T 4.2 Suppression annonce par son utilisateur1", () => {
        return axios({
            ...
            .then(response => {
                //console.log("reponse T 4.2 supp par user")
                //console.log("msg : "+response.data["payload"].message); "Offer deleted"
                const code = response.status;
                const expectedCode = 200;
    ...
    it("T 4.3 Consultation d'une annonce supprimée", () =>{
        return axios.get(`${URL}/offer/${id}`)
        .catch(error =>{
            console.log("error T 4.3 paiement")
            console.log("CodeErr : "+error.response.status);
            console.log("MsgErr : "+error.response.data.message); 
